...
public class QuickSort 
{
	...
	if(start == end){ }
	    ...
	    //pick random index between start and end as pivot
	    int pivot = (int)(Math.random() * (end-start)) + start;
	    int q = Mysterion(d, start, end, pivot);
	    if(q==start){
    ...
    //return s, the final resting position of the pivot	
    public static int Mysterion(int[] arr, int start, int end, int pivot){
	int v = arr[pivot];
	swap(pivot, end, arr);
	int s = start;
